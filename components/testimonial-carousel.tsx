...
const testimonials: Testimonial[] = [
  {
    ...
    service: "Olah Data (ATLAS.ti)",
    rating: 5,
    text: "Sangat terbantu dengan analisis data menggunakan ATLAS.ti dari Erudite. Penjelasannya runtut dan sangat mudah dipahami saat bimbingan hasil.",
  },
  {
    id: 2,
    name: "Dr. Rina Handayani",
    role: "Dosen & Peneliti Muda",
    institution: "Universitas Airlangga",
    service: "Mentoring Jurnal Scopus",
    rating: 5,
    text: "Bimbingan intensif dari mentor Erudite membantu saya menyelesaikan draft jurnal Scopus dalam waktu kurang dari sebulan. Sangat profesional dan terarah!",
  },
  {
    id: 3,
    name: "Budi Santoso",
    role: "Peserta Study Club",
    institution: "Universitas Indonesia",
    service: "Study Club Batch 6",
    rating: 5,
    text: "Materi reference management kemarin daging banget! Cara penyampaian pematerinya interaktif dan rekaman sesinya sangat membantu untuk belajar ulang.",
  },
  {
    id: 4,
    name: "Siti Aminah",
    role: "Peneliti Sosial",
    institution: "Lembaga Riset Independen",
    service: "Validasi Instrumen & Transkrip",
    rating: 5,
    text: "Validasi instrumen dan transkrip wawancara kualitatif dikerjakan dengan sangat teliti, rapi, dan selesai lebih cepat dari estimasi awal.",
  },
  {
    id: 5,
    name: "Kevin Wijaya",
    ...
    service: "Mentoring Skripsi/Tesis",
    rating: 5,
    text: "Dari yang awalnya bingung mulai dari mana, sekarang jadi paham betul karena didampingi langkah demi langkah dari bab 1 sampai akhir. Recommended partner!",
  },
];
